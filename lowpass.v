...
// Generated on: 2020-10-31 13:53:10
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000010010010; //sfix16_En17
  parameter signed [15:0] coeff2 = 16'b0000000011111001; //sfix16_En17
  parameter signed [15:0] coeff3 = 16'b0000000110010100; //sfix16_En17
  parameter signed [15:0] coeff4 = 16'b0000001000101001; //sfix16_En17
  parameter signed [15:0] coeff5 = 16'b0000001010000111; //sfix16_En17
  parameter signed [15:0] coeff6 = 16'b0000001001110001; //sfix16_En17
  parameter signed [15:0] coeff7 = 16'b0000000110101110; //sfix16_En17
  parameter signed [15:0] coeff8 = 16'b0000000000011010; //sfix16_En17
  parameter signed [15:0] coeff9 = 16'b1111110110111000; //sfix16_En17
  parameter signed [15:0] coeff10 = 16'b1111101011000010; //sfix16_En17
  parameter signed [15:0] coeff11 = 16'b1111011110101001; //sfix16_En17
  parameter signed [15:0] coeff12 = 16'b1111010100010100; //sfix16_En17
  parameter signed [15:0] coeff13 = 16'b1111001111000111; //sfix16_En17
  parameter signed [15:0] coeff14 = 16'b1111010010000110; //sfix16_En17
  parameter signed [15:0] coeff15 = 16'b1111011111101100; //sfix16_En17
  parameter signed [15:0] coeff16 = 16'b1111111001001000; //sfix16_En17
  parameter signed [15:0] coeff17 = 16'b0000011101111111; //sfix16_En17
  parameter signed [15:0] coeff18 = 16'b0001001011111111; //sfix16_En17
  parameter signed [15:0] coeff19 = 16'b0001111111000110; //sfix16_En17
  parameter signed [15:0] coeff20 = 16'b0010110010000100; //sfix16_En17
  parameter signed [15:0] coeff21 = 16'b0011011111000100; //sfix16_En17
  parameter signed [15:0] coeff22 = 16'b0100000000101010; //sfix16_En17
  parameter signed [15:0] coeff23 = 16'b0100010010100111; //sfix16_En17
  parameter signed [15:0] coeff24 = 16'b0100010010100111; //sfix16_En17
  parameter signed [15:0] coeff25 = 16'b0100000000101010; //sfix16_En17
  parameter signed [15:0] coeff26 = 16'b0011011111000100; //sfix16_En17
  parameter signed [15:0] coeff27 = 16'b0010110010000100; //sfix16_En17
  parameter signed [15:0] coeff28 = 16'b0001111111000110; //sfix16_En17
  parameter signed [15:0] coeff29 = 16'b0001001011111111; //sfix16_En17
  parameter signed [15:0] coeff30 = 16'b0000011101111111; //sfix16_En17
  parameter signed [15:0] coeff31 = 16'b1111111001001000; //sfix16_En17
  parameter signed [15:0] coeff32 = 16'b1111011111101100; //sfix16_En17
  parameter signed [15:0] coeff33 = 16'b1111010010000110; //sfix16_En17
  parameter signed [15:0] coeff34 = 16'b1111001111000111; //sfix16_En17
  parameter signed [15:0] coeff35 = 16'b1111010100010100; //sfix16_En17
  parameter signed [15:0] coeff36 = 16'b1111011110101001; //sfix16_En17
  parameter signed [15:0] coeff37 = 16'b1111101011000010; //sfix16_En17
  parameter signed [15:0] coeff38 = 16'b1111110110111000; //sfix16_En17
  parameter signed [15:0] coeff39 = 16'b0000000000011010; //sfix16_En17
  parameter signed [15:0] coeff40 = 16'b0000000110101110; //sfix16_En17
  parameter signed [15:0] coeff41 = 16'b0000001001110001; //sfix16_En17
  parameter signed [15:0] coeff42 = 16'b0000001010000111; //sfix16_En17
  parameter signed [15:0] coeff43 = 16'b0000001000101001; //sfix16_En17
  parameter signed [15:0] coeff44 = 16'b0000000110010100; //sfix16_En17
  parameter signed [15:0] coeff45 = 16'b0000000011111001; //sfix16_En17
  parameter signed [15:0] coeff46 = 16'b0000000010010010; //sfix16_En17

  // Signals
  reg  signed [15:0] delay_pipeline [0:45] ; // sfix16_En15
  ...
  assign mul_temp = delay_pipeline[45] * coeff46;
  assign product46 = mul_temp[30:0];

  assign mul_temp_1 = delay_pipeline[44] * coeff45;
  assign product45 = mul_temp_1[30:0];

  assign mul_temp_2 = delay_pipeline[43] * coeff44;
  assign product44 = mul_temp_2[30:0];

  assign mul_temp_3 = delay_pipeline[42] * coeff43;
  assign product43 = mul_temp_3[30:0];

  assign mul_temp_4 = delay_pipeline[41] * coeff42;
  assign product42 = mul_temp_4[30:0];

  assign mul_temp_5 = delay_pipeline[40] * coeff41;
  assign product41 = mul_temp_5[30:0];

  assign mul_temp_6 = delay_pipeline[39] * coeff40;
  assign product40 = mul_temp_6[30:0];

  assign mul_temp_7 = delay_pipeline[38] * coeff39;
  assign product39 = mul_temp_7[30:0];

  assign mul_temp_8 = delay_pipeline[37] * coeff38;
  assign product38 = mul_temp_8[30:0];

  assign mul_temp_9 = delay_pipeline[36] * coeff37;
  assign product37 = mul_temp_9[30:0];

  assign mul_temp_10 = delay_pipeline[35] * coeff36;
  assign product36 = mul_temp_10[30:0];

  assign mul_temp_11 = delay_pipeline[34] * coeff35;
  assign product35 = mul_temp_11[30:0];

  assign mul_temp_12 = delay_pipeline[33] * coeff34;
  assign product34 = mul_temp_12[30:0];

  assign mul_temp_13 = delay_pipeline[32] * coeff33;
  assign product33 = mul_temp_13[30:0];

  assign mul_temp_14 = delay_pipeline[31] * coeff32;
  assign product32 = mul_temp_14[30:0];

  assign mul_temp_15 = delay_pipeline[30] * coeff31;
  assign product31 = mul_temp_15[30:0];

  assign mul_temp_16 = delay_pipeline[29] * coeff30;
  assign product30 = mul_temp_16[30:0];

  assign mul_temp_17 = delay_pipeline[28] * coeff29;
  assign product29 = mul_temp_17[30:0];

  assign mul_temp_18 = delay_pipeline[27] * coeff28;
  assign product28 = mul_temp_18[30:0];

  assign mul_temp_19 = delay_pipeline[26] * coeff27;
  assign product27 = mul_temp_19[30:0];

  assign mul_temp_20 = delay_pipeline[25] * coeff26;
  assign product26 = mul_temp_20[30:0];

  assign mul_temp_21 = delay_pipeline[24] * coeff25;
  assign product25 = mul_temp_21[30:0];

  assign mul_temp_22 = delay_pipeline[23] * coeff24;
  assign product24 = mul_temp_22[30:0];

  assign mul_temp_23 = delay_pipeline[22] * coeff23;
  assign product23 = mul_temp_23[30:0];

  assign mul_temp_24 = delay_pipeline[21] * coeff22;
  assign product22 = mul_temp_24[30:0];

  assign mul_temp_25 = delay_pipeline[20] * coeff21;
  assign product21 = mul_temp_25[30:0];

  assign mul_temp_26 = delay_pipeline[19] * coeff20;
  assign product20 = mul_temp_26[30:0];

  assign mul_temp_27 = delay_pipeline[18] * coeff19;
  assign product19 = mul_temp_27[30:0];

  assign mul_temp_28 = delay_pipeline[17] * coeff18;
  assign product18 = mul_temp_28[30:0];

  assign mul_temp_29 = delay_pipeline[16] * coeff17;
  assign product17 = mul_temp_29[30:0];

  assign mul_temp_30 = delay_pipeline[15] * coeff16;
  assign product16 = mul_temp_30[30:0];

  assign mul_temp_31 = delay_pipeline[14] * coeff15;
  assign product15 = mul_temp_31[30:0];

  assign mul_temp_32 = delay_pipeline[13] * coeff14;
  assign product14 = mul_temp_32[30:0];

  assign mul_temp_33 = delay_pipeline[12] * coeff13;
  assign product13 = mul_temp_33[30:0];

  assign mul_temp_34 = delay_pipeline[11] * coeff12;
  assign product12 = mul_temp_34[30:0];

  assign mul_temp_35 = delay_pipeline[10] * coeff11;
  assign product11 = mul_temp_35[30:0];

  assign mul_temp_36 = delay_pipeline[9] * coeff10;
  assign product10 = mul_temp_36[30:0];

  assign mul_temp_37 = delay_pipeline[8] * coeff9;
  assign product9 = mul_temp_37[30:0];

  assign mul_temp_38 = delay_pipeline[7] * coeff8;
  assign product8 = mul_temp_38[30:0];

  assign mul_temp_39 = delay_pipeline[6] * coeff7;
  assign product7 = mul_temp_39[30:0];

  assign mul_temp_40 = delay_pipeline[5] * coeff6;
  assign product6 = mul_temp_40[30:0];

  assign mul_temp_41 = delay_pipeline[4] * coeff5;
  assign product5 = mul_temp_41[30:0];

  assign mul_temp_42 = delay_pipeline[3] * coeff4;
  assign product4 = mul_temp_42[30:0];

  assign mul_temp_43 = delay_pipeline[2] * coeff3;
  assign product3 = mul_temp_43[30:0];

  assign mul_temp_44 = delay_pipeline[1] * coeff2;
  assign product2 = mul_temp_44[30:0];

  assign mul_temp_45 = delay_pipeline[0] * coeff1;
  assign product1 = mul_temp_45[30:0];

  assign add_signext = product46;
  assign add_signext_1 = product45;
  assign add_temp = add_signext + add_signext_1;
  assign sum1_1 = $signed({{2{add_temp[31]}}, add_temp});

  assign add_signext_2 = product44;
  assign add_signext_3 = product43;
  assign add_temp_1 = add_signext_2 + add_signext_3;
  assign sum1_2 = $signed({{2{add_temp_1[31]}}, add_temp_1});

  assign add_signext_4 = product42;
  assign add_signext_5 = product41;
  assign add_temp_2 = add_signext_4 + add_signext_5;
  assign sum1_3 = $signed({{2{add_temp_2[31]}}, add_temp_2});

  assign add_signext_6 = product40;
  assign add_signext_7 = product39;
  assign add_temp_3 = add_signext_6 + add_signext_7;
  assign sum1_4 = $signed({{2{add_temp_3[31]}}, add_temp_3});

  assign add_signext_8 = product38;
  assign add_signext_9 = product37;
  assign add_temp_4 = add_signext_8 + add_signext_9;
  assign sum1_5 = $signed({{2{add_temp_4[31]}}, add_temp_4});

  assign add_signext_10 = product36;
  assign add_signext_11 = product35;
  assign add_temp_5 = add_signext_10 + add_signext_11;
  assign sum1_6 = $signed({{2{add_temp_5[31]}}, add_temp_5});

  assign add_signext_12 = product34;
  assign add_signext_13 = product33;
  assign add_temp_6 = add_signext_12 + add_signext_13;
  assign sum1_7 = $signed({{2{add_temp_6[31]}}, add_temp_6});

  assign add_signext_14 = product32;
  assign add_signext_15 = product31;
  assign add_temp_7 = add_signext_14 + add_signext_15;
  assign sum1_8 = $signed({{2{add_temp_7[31]}}, add_temp_7});

  assign add_signext_16 = product30;
  assign add_signext_17 = product29;
  assign add_temp_8 = add_signext_16 + add_signext_17;
  assign sum1_9 = $signed({{2{add_temp_8[31]}}, add_temp_8});

  assign add_signext_18 = product28;
  assign add_signext_19 = product27;
  assign add_temp_9 = add_signext_18 + add_signext_19;
  assign sum1_10 = $signed({{2{add_temp_9[31]}}, add_temp_9});

  assign add_signext_20 = product26;
  assign add_signext_21 = product25;
  assign add_temp_10 = add_signext_20 + add_signext_21;
  assign sum1_11 = $signed({{2{add_temp_10[31]}}, add_temp_10});

  assign add_signext_22 = product24;
  assign add_signext_23 = product23;
  assign add_temp_11 = add_signext_22 + add_signext_23;
  assign sum1_12 = $signed({{2{add_temp_11[31]}}, add_temp_11});

  assign add_signext_24 = product22;
  assign add_signext_25 = product21;
  assign add_temp_12 = add_signext_24 + add_signext_25;
  assign sum1_13 = $signed({{2{add_temp_12[31]}}, add_temp_12});

  assign add_signext_26 = product20;
  assign add_signext_27 = product19;
  assign add_temp_13 = add_signext_26 + add_signext_27;
  assign sum1_14 = $signed({{2{add_temp_13[31]}}, add_temp_13});

  assign add_signext_28 = product18;
  assign add_signext_29 = product17;
  assign add_temp_14 = add_signext_28 + add_signext_29;
  assign sum1_15 = $signed({{2{add_temp_14[31]}}, add_temp_14});

  assign add_signext_30 = product16;
  assign add_signext_31 = product15;
  assign add_temp_15 = add_signext_30 + add_signext_31;
  assign sum1_16 = $signed({{2{add_temp_15[31]}}, add_temp_15});

  assign add_signext_32 = product14;
  assign add_signext_33 = product13;
  assign add_temp_16 = add_signext_32 + add_signext_33;
  assign sum1_17 = $signed({{2{add_temp_16[31]}}, add_temp_16});

  assign add_signext_34 = product12;
  assign add_signext_35 = product11;
  assign add_temp_17 = add_signext_34 + add_signext_35;
  assign sum1_18 = $signed({{2{add_temp_17[31]}}, add_temp_17});

  assign add_signext_36 = product10;
  assign add_signext_37 = product9;
  assign add_temp_18 = add_signext_36 + add_signext_37;
  assign sum1_19 = $signed({{2{add_temp_18[31]}}, add_temp_18});

  assign add_signext_38 = product8;
  assign add_signext_39 = product7;
  assign add_temp_19 = add_signext_38 + add_signext_39;
  assign sum1_20 = $signed({{2{add_temp_19[31]}}, add_temp_19});

  assign add_signext_40 = product6;
  assign add_signext_41 = product5;
  assign add_temp_20 = add_signext_40 + add_signext_41;
  assign sum1_21 = $signed({{2{add_temp_20[31]}}, add_temp_20});

  assign add_signext_42 = product4;
  assign add_signext_43 = product3;
  assign add_temp_21 = add_signext_42 + add_signext_43;
  assign sum1_22 = $signed({{2{add_temp_21[31]}}, add_temp_21});

  assign add_signext_44 = product2;
  assign add_signext_45 = product1;
  assign add_temp_22 = add_signext_44 + add_signext_45;
  assign sum1_23 = $signed({{2{add_temp_22[31]}}, add_temp_22});

  assign add_signext_46 = sum1_1;
  assign add_signext_47 = sum1_2;
  assign add_temp_23 = add_signext_46 + add_signext_47;
  assign sum2_1 = add_temp_23[33:0];

  assign add_signext_48 = sum1_3;
  assign add_signext_49 = sum1_4;
  assign add_temp_24 = add_signext_48 + add_signext_49;
  assign sum2_2 = add_temp_24[33:0];

  assign add_signext_50 = sum1_5;
  assign add_signext_51 = sum1_6;
  assign add_temp_25 = add_signext_50 + add_signext_51;
  assign sum2_3 = add_temp_25[33:0];

  assign add_signext_52 = sum1_7;
  assign add_signext_53 = sum1_8;
  assign add_temp_26 = add_signext_52 + add_signext_53;
  assign sum2_4 = add_temp_26[33:0];

  assign add_signext_54 = sum1_9;
  assign add_signext_55 = sum1_10;
  assign add_temp_27 = add_signext_54 + add_signext_55;
  assign sum2_5 = add_temp_27[33:0];

  assign add_signext_56 = sum1_11;
  assign add_signext_57 = sum1_12;
  assign add_temp_28 = add_signext_56 + add_signext_57;
  assign sum2_6 = add_temp_28[33:0];

  assign add_signext_58 = sum1_13;
  assign add_signext_59 = sum1_14;
  assign add_temp_29 = add_signext_58 + add_signext_59;
  assign sum2_7 = add_temp_29[33:0];

  assign add_signext_60 = sum1_15;
  assign add_signext_61 = sum1_16;
  assign add_temp_30 = add_signext_60 + add_signext_61;
  assign sum2_8 = add_temp_30[33:0];

  assign add_signext_62 = sum1_17;
  assign add_signext_63 = sum1_18;
  assign add_temp_31 = add_signext_62 + add_signext_63;
  assign sum2_9 = add_temp_31[33:0];

  assign add_signext_64 = sum1_19;
  assign add_signext_65 = sum1_20;
  assign add_temp_32 = add_signext_64 + add_signext_65;
  assign sum2_10 = add_temp_32[33:0];

  assign add_signext_66 = sum1_21;
  assign add_signext_67 = sum1_22;
  assign add_temp_33 = add_signext_66 + add_signext_67;
  assign sum2_11 = add_temp_33[33:0];

  assign add_signext_68 = sum2_1;
  assign add_signext_69 = sum2_2;
  assign add_temp_34 = add_signext_68 + add_signext_69;
  assign sum3_1 = add_temp_34[33:0];

  assign add_signext_70 = sum2_3;
  assign add_signext_71 = sum2_4;
  assign add_temp_35 = add_signext_70 + add_signext_71;
  assign sum3_2 = add_temp_35[33:0];

  assign add_signext_72 = sum2_5;
  assign add_signext_73 = sum2_6;
  assign add_temp_36 = add_signext_72 + add_signext_73;
  assign sum3_3 = add_temp_36[33:0];

  assign add_signext_74 = sum2_7;
  assign add_signext_75 = sum2_8;
  assign add_temp_37 = add_signext_74 + add_signext_75;
  assign sum3_4 = add_temp_37[33:0];

  assign add_signext_76 = sum2_9;
  assign add_signext_77 = sum2_10;
  assign add_temp_38 = add_signext_76 + add_signext_77;
  assign sum3_5 = add_temp_38[33:0];

  assign add_signext_78 = sum2_11;
  assign add_signext_79 = sum1_23;
  assign add_temp_39 = add_signext_78 + add_signext_79;
  assign sum3_6 = add_temp_39[33:0];

  assign add_signext_80 = sum3_1;
  assign add_signext_81 = sum3_2;
  assign add_temp_40 = add_signext_80 + add_signext_81;
  assign sum4_1 = add_temp_40[33:0];

  assign add_signext_82 = sum3_3;
  assign add_signext_83 = sum3_4;
  assign add_temp_41 = add_signext_82 + add_signext_83;
  assign sum4_2 = add_temp_41[33:0];

  assign add_signext_84 = sum3_5;
  assign add_signext_85 = sum3_6;
  assign add_temp_42 = add_signext_84 + add_signext_85;
  assign sum4_3 = add_temp_42[33:0];

  assign add_signext_86 = sum4_1;
  assign add_signext_87 = sum4_2;
  assign add_temp_43 = add_signext_86 + add_signext_87;
  assign sum5_1 = add_temp_43[33:0];

  assign add_signext_88 = sum5_1;
  assign add_signext_89 = sum4_3;
  assign add_temp_44 = add_signext_88 + add_signext_89;
  assign sum6_1 = add_temp_44[33:0];
